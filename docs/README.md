...
- [**Submission Requirements & Project Rules**](/docs/requirements_and_rules.md): Detailed rules on repos, licenses, videos, and existing vs new code.
- [**WebMCP Architecture & Tool Spec**](/docs/webmcp_spec_and_architecture.md): API signature, tool schemas, TypeScript definitions, and security guidelines.
- [**Deployment & Testing Guide**](/docs/deployment_and_testing.md): Hosting options (Cloudflare, Vercel, Netlify, Render) and browser testing environments.
- [**Judging & Scoring Criteria**](/docs/judging_criteria.md): The 4 evaluation pillars and how to score maximum points.
- [**Developer Resources & Templates**](/docs/resources_and_templates.md): Starter codebases, React hooks, Chrome labs demos, and official documentation.
- [**Technical FAQ & AI Usage**](/docs/faq.md): Practical answers on repositories, hosting, auth, and AI assistance.
