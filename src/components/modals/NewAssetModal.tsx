      ...
      <div className="bg-studio-900 border border-studio-700/80 w-full max-w-lg rounded-xl shadow-2xl overflow-hidden flex flex-col">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-studio-800 bg-studio-850/50">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-base font-semibold text-white">Create New Sprite Asset</h2>
              <p className="text-xs text-slate-400">Configure canvas dimensions, animation states, and palette</p>
            </div>
          </div>
          <button
            onClick={closeModal}
        ...
        <form onSubmit={handleCreate} className="p-6 space-y-5 overflow-y-auto max-h-[75vh]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="space-y-1.5">
              <label className="text-xs font-medium text-slate-300">Sprite Name</label>
              <input
                type="text"
                value={name}
                onChange={(e) => setName(e.target.value)}
                placeholder="e.g. Archer Hero"
                autoFocus
                className="w-full px-3 py-2 text-sm bg-studio-950 border border-studio-700 rounded-lg text-white placeholder:text-slate-500 focus:outline-none focus:border-accent-500 transition-colors"
              />
            </div>
            <div className="space-y-1.5">
              ...
              <select
                ...
                className="w-full px-3 py-2 text-sm bg-studio-950 border border-studio-700 rounded-lg text-white focus:outline-none focus:border-accent-500 transition-colors"
              >
                {CATEGORIES.map((cat) => (
          ...
          <div className="space-y-2">
            <label className="text-xs font-medium text-slate-300">Animation Template</label>
            <div className="grid grid-cols-3 gap-2.5">
              ...
              >
                <div className="text-xs font-semibold text-slate-200">RPG Standard</div>
                <div className="text-[11px] text-slate-400 mt-1">Idle, Walk, Attack</div>
              </button>
              <button
                type="button"
              ...
              >
                <div className="text-xs font-semibold text-slate-200">Platformer</div>
                <div className="text-[11px] text-slate-400 mt-1">Idle, Run, Jump, Death</div>
              </button>
              <button
                type="button"
              ...
              >
                <div className="text-xs font-semibold text-slate-200">Single State</div>
                <div className="text-[11px] text-slate-400 mt-1">Idle (Static / Item)</div>
              </button>
            </div>
          </div>
          ...
          {/* Starter Palette */}
          <div className="space-y-2">
            <label className="text-xs font-medium text-slate-300">Initial Color Palette</label>
          ...
          <div className="flex items-center justify-end gap-3 pt-4 border-t border-studio-800">
            ...
            <button
              type="submit"
              className="px-5 py-2 text-xs font-medium text-white bg-accent-600 hover:bg-accent-500 rounded-lg shadow-glow-sm transition-all flex items-center gap-1.5"
            >
